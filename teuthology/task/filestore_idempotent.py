    ...
    try:
        ...
        remote.run(
            args=[
                ...
                'http://ceph.com/git/?p=ceph.git;a=blob_plain;f=src/test/filestore/run_seed_to.sh;hb=3f5c25279622ea59624ae689cd21e9d69c852c0c',
                run.Raw('&&'),
                'wget','-q', '-Orun_seed_to_range.sh',
                'http://ceph.com/git/?p=ceph.git;a=blob_plain;f=src/test/filestore/run_seed_to_range.sh;hb=3f5c25279622ea59624ae689cd21e9d69c852c0c',
                run.Raw('&&'),
